...
scattering_real = waSc.scatteringHandler(
    J, (128, 128), backend="numpy", frontend="numpy", L=L
)
scattering_fake = waSc.scatteringHandler(
    J, (128, 128), backend="numpy", frontend="numpy", L=L
)
...
print("plotting")
scPl.plot_2o_Estimators(
    s22_j1j2_fake, s22_j1j2_real, "Shape_" + str(n), J, L, output_dir
)
scPl.plot_2o_Estimators(
    s21_j1j2_fake, s21_j1j2_real, "Sparsity_" + str(n), J, L, output_dir
)
scPl.plot_1o_Estimators(S1_l_fake, S1_l_real, "S1,l_" + str(n), J, L, output_dir)
